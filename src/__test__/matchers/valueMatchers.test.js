...
describe("toMatchObject 확인하기", () => {
    ...
    test.skip("{ id: 1 }", () => expect({ id: 1, pw: 10 }).toMatchObject({ id: 10 }));
});

describe("toStrictEqual 확인하기", () => {
    // 객체의 키의 값이 모두 일치해야 통과한다.
    test("{ id: 1 }", () => expect({ id: 1, pw: 10 }).toStrictEqual({ id: 1, pw: 10 }));
    test.skip("{ id: 1 }", () => expect({ id: 1, pw: 10 }).toStrictEqual({ id: 1, pw: 15 }));
});
...
describe("toBeCloseTo 확인하기", () => {
    ...
    test.skip('0.2 + 0.1 === 0.3', () => expect(0.2 + 0.1).toBe(0.3));
...
describe("toBeGreaterThan 확인하기", () => {
    ...
    test.skip("2 > 1", () => expect(2).toBeGreaterThan(2));
});
...
describe("toBeLessThan 확인하기", () => {
    ...
    test.skip("1 <= 2", () => expect(1).toBeLessThan(1));
});
